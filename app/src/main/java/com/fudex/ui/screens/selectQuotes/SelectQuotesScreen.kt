...
@Composable
fun SelectQuotesScreen(
    modifier: Modifier = Modifier,
    viewModel: SelectQuotesViewModel = hiltViewModel(),
    //onConfirm: () -> Unit = {},
    onCancel: () -> Unit = {},
    navToPaymentConfirm: () -> Unit = {},
    navBack: () -> Unit = {},
){
    ...
    val total = 1000.0
    val quoteValue = total / selectedCuota
    ...
    Column(
        ...
        Column(
            ...
            Column(
                ...
                Text(
                    text = "$selectedCuota cuota${if (selectedCuota > 1) "s" else ""} de $${"%.2f".format(quoteValue)}",
